  ...
  function initializeSwagger() {
    ...
    try {
      ...
      const baseConfig = {
        ...
        onComplete: function() {
          console.log('Swagger UI para Team Battles cargado correctamente');
        },
        onFailure: function(error) {
          console.error('Error cargando Swagger UI para Team Battles:', error);
        }
      };
      ...
      console.error('Error al inicializar Swagger UI para Team Battles:', error);
    }
  }
