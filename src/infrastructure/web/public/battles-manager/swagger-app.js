// Configuración de Swagger UI para Battles Manager
window.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeSwagger() {
    ...
    try {
      ...
      const baseConfig = {
        url: '/api/docs/swagger-battles.json',
        dom_id: '#swagger-ui',
      ...
      onComplete: function() {
        console.log('Swagger UI para Battles cargado correctamente');
      },
      onFailure: function(error) {
        console.error('Error cargando Swagger UI para Battles:', error);
      }
      };
      ...
      console.error('Error al inicializar Swagger UI para Battles:', error);
    }
  }
