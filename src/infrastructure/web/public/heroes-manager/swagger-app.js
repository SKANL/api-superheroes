// Configuración de Swagger UI para Heroes Manager
window.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeSwagger() {
    ...
    try {
      ...
      const baseConfig = {
        url: '/api/docs/swagger-heroes.json',
        dom_id: '#swagger-ui',
        ...
        onComplete: function() {
          console.log('Swagger UI para Heroes cargado correctamente');
        },
        onFailure: function(error) {
          console.error('Error cargando Swagger UI para Heroes:', error);
        }
      };
      ...
      console.error('Error al inicializar Swagger UI para Heroes:', error);
    }
  }
